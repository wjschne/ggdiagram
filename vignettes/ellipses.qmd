...
bp + 
  {e1 <- ob_ellipse(ob_point(-2,-1, 
                 ...
                 a = 2, 
                 b = 1.5)} +
  {e2 <- place(ob_ellipse(ob_point(color = "orchid4"),
                       b = 2), 
               from = e1, 
               where = deg, 
               sep = 2)} + 
  ...
  ob_segment(e1@center, e1@point_at(deg)) + 
  ob_segment(e2@center, e2@point_at(deg + degree(180))) + 
...
bp + 
  ...
  connect(e1, l1, 
          ...
          length_head = 8, 
          resect = 1) + 
  ob_label(label = l1@equation, 
        p = ob_polar(theta = deg1, 
...
e1 <- ob_ellipse(ob_point(runif(n,-2,2), 
                      runif(n,-2,2)),
                a = runif(n, .5, 1.5),
                b = runif(n, .5, 1.5),
                m1 = runif(n,2,10),
...
ggplot() + coord_equal() + theme_minimal() +
  e1 + 
  e1@bounding_box 
  # rectangle(southwest = ob_point(d_rect$xmin, d_rect$ymin),
