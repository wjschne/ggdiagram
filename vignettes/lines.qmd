...
```{r construct_line}
l <- line(slope = 2, intercept = 1, color = "royalblue3")
l
```
...
```{r hline}
h <- line(intercept = 2, color = "royalblue3")
h
```
...
```{r vline}
v <- line(xintercept = -2, color = "royalblue3")
v
```
...
```{r abcline}
l_123 <- line(a = 1, b = 2, c = 3, color = "royalblue3")
```
...
```{r projection}
p <- point(1,-1, color = "firebrick4")
l <- line(slope = 2, intercept = 2, color = "royalblue3")
