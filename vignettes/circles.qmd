...
bp +
  ...
  segment(
    ...
    c1@point_at(0),
    color = my_colors[1],
    label = label(paste0("*r* = ", c1@radius), angle = 0, vjust = 0)
  )
...
bp +
  {c7 <- circle()} +
  place(line(), c7, where = degree(45), sep = 1)
```
