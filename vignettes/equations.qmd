...
For example, suppose I want to label a latent variable's variance with the symbol $\sigma_e^2$. This symbol would be difficult to render in HTML, so we can render it in LaTeX instead.
