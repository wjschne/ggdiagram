...
ggdiagram() +
  ...
  ob_ngon(
    ...
    angle = degree(90),
    style = style_shape,
    label = my_label("Triangle", nudge_y = -0.25))
```
...
ggdiagram(font_size = 16) +
  ...
  connect(
    ...
    label = ob_label(label = round_probability(loadings),
                     angle = 0))@set_label_y(position = 0.5) +
  # Error variances
  ob_variance(
    A_3,
    where = "south",
