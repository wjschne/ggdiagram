...
update_geom_defaults("arrow_segment", list(length_head = 5, linewidth = 0.5))
```
...
bp +
  ...
  ob_segment(ob_point(), p1, linewidth = 0.2) +
  {p2 <- e1@point_at(theta, definitional = TRUE, color = "dodgerblue")} +
