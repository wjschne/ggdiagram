...
In this tutorial, we have a look at how ggdigram can be used to draw geometric constructions.
...
ggdiagram(font_size = 16) +
  ...
  D + 
  E + 
  D@point_at("left")@label("D", hjust = 1.1) +
  E@point_at("right")@label("E", hjust = -0.1)
```
