...
This outlines how to propose a change to ggdiagram. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("wjschne/ggdiagram", fork = TRUE)`.
...
Please note that the ggdiagram project is released with a [Contributor
Code of
Conduct](https://wjschne.github.io/ggdiagram/CODE_OF_CONDUCT.md). By
